...
public class ExecutionLogger {
    ...
    public synchronized void logReadResponse(long tid, String value) throws IOException {
	if (!started || stopped) return;
	out.write("" + (System.nanoTime() - startTime));
	out.write("\tRES");
	out.write("\t" + tid);
    ...
    public synchronized void logWriteResponse(long tid) throws IOException {
	if (!started || stopped) return;
	out.write("" + (System.nanoTime() - startTime));
	out.write("\tRES");
	out.write("\t" + tid);
